...
import { IEventHandling } from './interfaces/IEventHandling';
/**
 * Extends objects with event handling capabilities.
 */
export default abstract class EventHandlingBase<TSender, TArgs> implements IEventHandling<TSender, TArgs> {
